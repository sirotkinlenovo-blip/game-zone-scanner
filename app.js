...
class GameScannerApp {
    ...
    setMode(isClientMode) {
        ...
        if (isClientMode) {
            ...
            // В клиентском режиме кнопка переключения всегда видна и называется "Режим разработчика"
    ...
    // Переключение режима с запросом пароля в клиентском режиме
    toggleMode() {
        if (this.isClientMode) {
            // Если в клиентском режиме - запрашиваем пароль
